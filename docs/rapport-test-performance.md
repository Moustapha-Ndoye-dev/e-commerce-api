...
![Vérification Java 17](screenshots/01-java-version.png)
...
![Compilation Gatling](screenshots/03-gatling-compile.png)
...
![Démarrage Spring Boot](screenshots/09-spring-boot-run.png)
...
![Réponse API produits](screenshots/10-api-response.png)
...
![Exécution Gatling](screenshots/11-gatling-run.png)
...
![Résumé terminal Global Information](screenshots/12-gatling-summary.png)
...
![Configuration Spring Boot Gradle](screenshots/05-spring-boot-build-gradle.png)
...
![Configuration Gatling Gradle](screenshots/06-gatling-build-gradle.png)
...
![Configuration application.properties](screenshots/07-application-properties.png)
...
![Code simulation Gatling](screenshots/08-gatling-simulation.png)
...
![Rapport Gatling — vue globale](screenshots/13-gatling-report-global.png)

*Figure 11 — Rapport HTML Gatling : statistiques globales et tableau des requêtes*

![Rapport Gatling — percentiles](screenshots/14-gatling-report-percentiles.png)

*Figure 12 — Graphique Response Time Percentiles (P50, P75, P95, P99)*

![Rapport Gatling — détail requêtes](screenshots/15-gatling-report-details.png)
...
### B. Comment ajouter les captures d'écran

1. Exécuter les étapes ci-dessus.
2. Prendre les captures avec **Win + Shift + S**.
3. Enregistrer les PNG dans `docs/screenshots/` avec les noms indiqués dans [screenshots/README.md](screenshots/README.md).
4. Les figures s'afficheront automatiquement dans ce rapport Markdown.

| Capture | Contenu à photographier |
|---------|-------------------------|
...
| `10-api-response.png` | JSON /api/products dans le navigateur |
| `11-gatling-run.png` | BUILD SUCCESSFUL après gatlingRun |
| `12-gatling-summary.png` | Tableau Global Information (terminal) |
| `13-gatling-report-global.png` | Rapport HTML — onglet Global |
| `14-gatling-report-percentiles.png` | Graphique percentiles |
| `15-gatling-report-details.png` | Tableau détail des 5 requêtes |

### C. Références

- [Guide technique du projet](performance-test-guide.md)
- [Rapport Gatling HTML](../performance-tests/build/reports/gatling/ecommercesimulation-20260524210717587/index.html)
- [Simulation source](../performance-tests/src/gatling/java/simulations/EcommerceSimulation.java)
